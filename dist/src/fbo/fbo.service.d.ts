...
export declare class FboService {
    private prisma;
    private stockService;
    private eventsGateway;
    constructor(prisma: PrismaService, stockService: StockService, eventsGateway: EventsGateway);
    findAll(filters: {
        clientId?: string;
    ...
    create(input: CreateSupplyInput): Promise<{
        client: {
            id: string;
            updatedAt: Date;
            type: import(".prisma/client").$Enums.ClientType;
    ...
    transitionStatus(id: string, status: SupplyStatus, userId?: string | null): Promise<{
        id: string;
        clientId: string;
        updatedAt: Date;
        createdAt: Date;
    ...
    scanPick(supplyId: string, barcode: string): Promise<{
        id: string;
        productId: string;
        supplyId: string;
        qtyNeeded: number;
    ...
    setBoxes(id: string, boxesCount: number, palletsCount?: number): import(".prisma/client").Prisma.Prisma__SupplyClient<{
        id: string;
        clientId: string;
        updatedAt: Date;
        createdAt: Date;
