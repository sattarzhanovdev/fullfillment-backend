...
export declare class ShipmentsController {
    ...
    findAll(status?: string, from?: string, to?: string): import(".prisma/client").Prisma.PrismaPromise<({
        orders: ({
            client: {
                id: string;
                name: string;
    ...
    create(body: any): import(".prisma/client").Prisma.Prisma__ShipmentClient<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        status: import(".prisma/client").$Enums.ShipmentStatus;
    ...
    update(id: string, body: any): import(".prisma/client").Prisma.Prisma__ShipmentClient<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        status: import(".prisma/client").$Enums.ShipmentStatus;
    ...
    addOrder(id: string, orderId: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        status: import(".prisma/client").$Enums.ShipmentStatus;
    ...
    addSupply(id: string, supplyId: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        status: import(".prisma/client").$Enums.ShipmentStatus;
