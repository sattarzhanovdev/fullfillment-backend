...
export declare class DashboardService {
    ...
    getAttentionOrders(take?: number): Promise<({
        client: {
            id: string;
            name: string;
        };
    ...
    getLowStockProducts(take?: number): Promise<{
        available: number;
        product: {
            client: {
                id: string;
    ...
    getRecentOrders(take?: number): Promise<({
        client: {
            id: string;
            name: string;
        };
    ...
    getUpcomingShipments(take?: number): Promise<({
        _count: {
            orders: number;
            supplies: number;
        };
